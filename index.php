...
<body>
    ...
    <header class="d-flex flex-column flex-column flex-md-row align-items-center p-3 px-md-4 mb-1 bg-white border-bottom shadow-sm">
        <a href="/" class="h5 my-0 me-md-auto fw-normal"><?php echo $username ?></a>
    ...
    <div class="masthead text-center text-white purple p-4">
        <div class="masthead-content">
            <div class="container">
                ...
                <a href="<?php echo $gitHubLink ?>" class="btn btn-primary btn-xl rounded-pill mt-5">My GitHub
                    Profile</a>
            </div>
        </div>
    ...
    <footer class="align-items-center p-3 px-md-4 mt-3 bg-white border-top shadow-sm">
        ...
        <p>&copy; 2022 <?php echo $username ?> &middot; <a href="/project.html">Project</a> &middot; <a href="/progress.html">Progress</a></p>
    </footer>
</body>
